...
namespace BotTranslation
{
    ...
    {
        private static string translationKey = "33da90d696284500a79658bfa021f55f";
        ...
        private static string FromLocale = "en";
        private static string ToLocale = "sv";
        ...
        public async Task<string> TranslateMessage(string text,string language)
        {
            return await TranslateMessageCore(text, FromLocale, language);
        }
        ...
        private async Task<string> TranslateMessageCore(string text, string FromLocale, string ToLocale)
        {
            ...
            HttpResponseMessage response = await client.GetAsync("http://api.microsofttranslator.com/v2/Http.svc/Translate?text=" + urlEncodedText + "&from=" + FromLocale + "&to=" + ToLocale+"&rating="+10);
