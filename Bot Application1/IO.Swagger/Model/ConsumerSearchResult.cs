...
{
    /// <summary>
    /// Bisnode&#39;s representation of a consumer in a search result.
    /// </summary>
    [DataContract]
    public partial class ConsumerSearchResult :  IEquatable<ConsumerSearchResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumerSearchResult" /> class.
        /// </summary>
        ...
        public ConsumerSearchResult(bool? Deceased = default(bool?), bool? _Protected = default(bool?), List<Address> AddressList = default(List<Address>), string GivenName = default(string), string FamilyName = default(string), string Memento = default(string), string FullName = default(string), List<string> FirstNames = default(List<string>), string Language = default(string), List<Telephone> PhoneList = default(List<Telephone>), string BisnodeConsumerId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsumerSearchResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConsumerSearchResult);
        }

        /// <summary>
        /// Returns true if ConsumerSearchResult instances are equal
        /// </summary>
        /// <param name="other">Instance of ConsumerSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsumerSearchResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
