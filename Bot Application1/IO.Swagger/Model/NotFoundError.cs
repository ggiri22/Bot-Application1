...
{
    /// <summary>
    /// The provided bisnodeConsumerId or memento doesn&#39;t match any consumer entity.
    /// </summary>
    [DataContract]
    public partial class NotFoundError :  IEquatable<NotFoundError>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Code">Code (default to &quot;PAGE_NOT_FOUND&quot;).</param>
        public NotFoundError(string Code = "PAGE_NOT_FOUND")
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NotFoundError);
        }

        /// <summary>
        /// Returns true if NotFoundError instances are equal
        /// </summary>
        /// <param name="other">Instance of NotFoundError to be compared</param>
        /// <returns>Boolean</returns>
