...
{
    /// <summary>
    /// The request was successful and a consumer entity is returned.
    /// </summary>
    [DataContract]
    public partial class ConsumerResponse :  IEquatable<ConsumerResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ConsumerResponse" /> class.
        /// </summary>
        /// <param name="Consumer">A consumer entity. (required).</param>
        public ConsumerResponse(List<ConsumerEntity> Consumer = default(List<ConsumerEntity>))
        {
            // to ensure "Consumer" is required (not null)
            if (Consumer == null)
            {
                throw new InvalidDataException("Consumer is a required property for ConsumerResponse and cannot be null");
            }
            else
            {
        ...
        /// A consumer entity.
        /// </summary>
        /// <value>A consumer entity.</value>
        [DataMember(Name="consumer", EmitDefaultValue=false)]
        public List<ConsumerEntity> Consumer { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConsumerResponse);
        }

        /// <summary>
        /// Returns true if ConsumerResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ConsumerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsumerResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Consumer != null &&
                    this.Consumer.SequenceEqual(other.Consumer)
                );
        }
