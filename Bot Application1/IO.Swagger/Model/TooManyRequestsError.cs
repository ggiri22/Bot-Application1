...
{
    /// <summary>
    /// The client has performed too many requests currently and is being rate limited by the server. The details of this depends on the client&#39;s contract with Bisnode.
    /// </summary>
    [DataContract]
    public partial class TooManyRequestsError :  IEquatable<TooManyRequestsError>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Code">Code (default to &quot;TOO_MANY_REQUESTS&quot;).</param>
        public TooManyRequestsError(string Code = "TOO_MANY_REQUESTS")
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TooManyRequestsError);
        }

        /// <summary>
        /// Returns true if TooManyRequestsError instances are equal
        /// </summary>
        /// <param name="other">Instance of TooManyRequestsError to be compared</param>
        /// <returns>Boolean</returns>
