...
{
    /// <summary>
    /// The client needs to provide valid authentication information in order to perform this request. Note that authentication tokens are only valid for a limited time after which a new one is to be retrieved and used.
    /// </summary>
    [DataContract]
    public partial class UnauthorizedError :  IEquatable<UnauthorizedError>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Code">Code (default to &quot;INVALID_AUTHENTICATION&quot;).</param>
        public UnauthorizedError(string Code = "INVALID_AUTHENTICATION")
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnauthorizedError);
        }
