...
{
    /// <summary>
    /// The server was unable to serve the request due to invalid syntax or data received from the client.
    /// </summary>
    [DataContract]
    public partial class BadRequestError :  IEquatable<BadRequestError>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Code">Code (default to &quot;BAD_REQUEST&quot;).</param>
        public BadRequestError(string Code = "BAD_REQUEST")
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BadRequestError);
        }
