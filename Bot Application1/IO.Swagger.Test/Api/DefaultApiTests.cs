...
namespace IO.Swagger.Test
{
    ...
    public class DefaultApiTests
    {
        ...
        public void GetConsumerTest()
        {
            ...
            //string bisnodeConsumerId = null;
            //string memento = null;
            //List<string> dataSet = null;
            //var response = instance.GetConsumer(bisnodeConsumerId, memento, dataSet);
            //Assert.IsInstanceOf<ConsumerResponse> (response, "response is ConsumerResponse");
        }
        
        /// <summary>
        /// Test SearchConsumers
        /// </summary>
        [Test]
        public void SearchConsumersTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<string> dataSet = null;
            //string country = null;
            ...
            //var response = instance.SearchConsumers(dataSet, country, familyName, givenName, dateOfBirth, phoneNumber);
            //Assert.IsInstanceOf<ConsumerSearchResultListResponse> (response, "response is ConsumerSearchResultListResponse");
        }
