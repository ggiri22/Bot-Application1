...
namespace IO.Swagger.Test
{
    ...
    public class UnauthorizedErrorTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" UnauthorizedError
            //Assert.IsInstanceOfType<UnauthorizedError> (instance, "variable 'instance' is a UnauthorizedError");
        }
